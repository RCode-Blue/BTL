...
- HtmlWebpackPlugin [README](https://github.com/jantimon/html-webpack-plugin)
- You should end up with the following folder structure:
...
| | _[homepage](https://nodemon.io/)_ \| _[npm](https://www.npmjs.com/package/nodemon)_ |

<br/>

5. Create node script
